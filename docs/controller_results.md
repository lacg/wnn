...
_Generated 03/06/2026 23:06:03 EDT from `/Users/lacg/wnn/logs/controller/curriculum/ic_sweep_20260601_140443.log`._
...
## Multi-seed rounds — held-out stable % across 2 seeds
...
| combo | weights | R1 | R2 | mean±std | rounds |
|---|---|---|---|---|---|
