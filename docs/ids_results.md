...
Status: 99 of 112 flows completed (as of 2026-03-30). ETA: 31 March ~08:30 UTC (04:30 AM ET).
Config: 2-phase (grid search + GA neurons), pop=50, top20 features at 16b, max_bits=34, kf5x5 fitness

### Grid Search — Best F1 Genome (99 flows)

Neurons: 334 ±116 | Bits: 34, 32

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.34% ±0.09% | 0.223% ±0.084% | 99.59% ±0.06% |
| train_cal | 99.33% ±0.11% | 0.200% ±0.068% | 99.58% ±0.07% |
| test_cal | 99.21% ±0.21% | 0.249% ±0.132% | 99.50% ±0.13% |
| fixed_05 | 99.25% ±0.14% | 0.351% ±0.086% | 99.53% ±0.09% |
| platt | 99.23% ±0.17% | 0.298% ±0.125% | 99.51% ±0.11% |
| beta | 99.26% ±0.16% | 0.272% ±0.088% | 99.53% ±0.10% |
| empirical | 98.27% ±0.73% | 1.270% ±0.637% | 98.88% ±0.49% |
| emp_cumul | 99.23% ±0.21% | 0.251% ±0.129% | 99.51% ±0.13% |

### Grid Search — Best FPR Genome (99 flows)

Neurons: 345 ±124 | Bits: 32, 34, other

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.32% ±0.08% | 0.224% ±0.071% | 99.57% ±0.05% |
| train_cal | 99.29% ±0.14% | 0.218% ±0.093% | 99.55% ±0.09% |
| test_cal | 99.17% ±0.22% | 0.240% ±0.119% | 99.48% ±0.14% |
| fixed_05 | 99.24% ±0.12% | 0.346% ±0.070% | 99.52% ±0.07% |
| platt | 99.22% ±0.17% | 0.304% ±0.088% | 99.51% ±0.11% |
| beta | 99.24% ±0.18% | 0.281% ±0.100% | 99.52% ±0.11% |
| empirical | 98.21% ±0.72% | 1.309% ±0.628% | 98.84% ±0.48% |
| emp_cumul | 99.21% ±0.19% | 0.250% ±0.101% | 99.50% ±0.12% |

### Grid Search — Best Fitness Genome (99 flows)

Neurons: 340 ±115 | Bits: 34, 32

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.35% ±0.07% | 0.212% ±0.064% | 99.59% ±0.05% |
| train_cal | 99.34% ±0.09% | 0.200% ±0.066% | 99.58% ±0.06% |
| test_cal | 99.22% ±0.20% | 0.253% ±0.120% | 99.51% ±0.12% |
| fixed_05 | 99.26% ±0.13% | 0.345% ±0.073% | 99.53% ±0.08% |
| platt | 99.22% ±0.18% | 0.298% ±0.122% | 99.51% ±0.12% |
| beta | 99.26% ±0.17% | 0.277% ±0.090% | 99.53% ±0.11% |
| empirical | 98.24% ±0.72% | 1.296% ±0.633% | 98.86% ±0.48% |
| emp_cumul | 99.22% ±0.21% | 0.250% ±0.130% | 99.51% ±0.13% |

### GA Neurons — Best F1 Genome (99 flows)

Neurons: 191 ±140 | Bits: 32, 34, 32-34, other

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.40% ±0.06% | 0.196% ±0.063% | 99.62% ±0.04% |
| train_cal | 99.39% ±0.09% | 0.201% ±0.081% | 99.61% ±0.06% |
| test_cal | 99.30% ±0.16% | 0.220% ±0.085% | 99.56% ±0.10% |
| fixed_05 | 99.23% ±0.12% | 0.416% ±0.104% | 99.51% ±0.07% |
| platt | 99.29% ±0.14% | 0.304% ±0.109% | 99.55% ±0.09% |
| beta | 99.31% ±0.14% | 0.268% ±0.079% | 99.57% ±0.09% |
| empirical | 98.66% ±0.60% | 0.932% ±0.532% | 99.14% ±0.40% |
| emp_cumul | 99.32% ±0.12% | 0.241% ±0.086% | 99.57% ±0.07% |

### GA Neurons — Best FPR Genome (99 flows)

Neurons: 231 ±167 | Bits: 32, 34, 32-34, other

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.30% ±0.17% | 0.234% ±0.103% | 99.56% ±0.11% |
| train_cal | 99.32% ±0.12% | 0.227% ±0.090% | 99.57% ±0.08% |
| test_cal | 99.17% ±0.27% | 0.274% ±0.179% | 99.48% ±0.17% |
| fixed_05 | 99.17% ±0.22% | 0.417% ±0.143% | 99.47% ±0.14% |
| platt | 99.24% ±0.20% | 0.313% ±0.153% | 99.52% ±0.13% |
| beta | 99.24% ±0.19% | 0.279% ±0.091% | 99.52% ±0.12% |
| empirical | 98.47% ±0.86% | 1.081% ±0.771% | 99.01% ±0.58% |
| emp_cumul | 99.18% ±0.33% | 0.281% ±0.166% | 99.48% ±0.20% |

### GA Neurons — Best Fitness Genome (99 flows)

Neurons: 194 ±143 | Bits: 32, 34, 32-34, other

| Threshold | F1 mean ±std | FPR mean ±std | Acc mean ±std |
|---|---|---|---|
| val_cal | 99.40% ±0.06% | 0.196% ±0.063% | 99.62% ±0.04% |
| train_cal | 99.39% ±0.09% | 0.200% ±0.082% | 99.61% ±0.06% |
| test_cal | 99.30% ±0.16% | 0.221% ±0.084% | 99.56% ±0.10% |
| fixed_05 | 99.23% ±0.12% | 0.416% ±0.104% | 99.51% ±0.07% |
| platt | 99.29% ±0.14% | 0.304% ±0.107% | 99.55% ±0.09% |
| beta | 99.30% ±0.17% | 0.269% ±0.085% | 99.56% ±0.10% |
| empirical | 98.65% ±0.60% | 0.940% ±0.534% | 99.13% ±0.40% |
| emp_cumul | 99.32% ±0.12% | 0.237% ±0.088% | 99.57% ±0.07% |
