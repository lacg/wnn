...
```
markers with a headline held-out : 254
  altitude regimen (alt= present) : 170
  attitude-only                   : 84
  state-neuron count unreadable   : 0  (no .out on disk)
  h743 keys counted exactly       : 60  (experiments/h743_keys.json)
  h743 fits, exact / bound        : 35 / 50
  h743 off-chip (16 MB QSPI) tier : 25 / 17
...
```
  ...
  rank  gate-dist  same-rule  fit  stable     err  steady     alt  h743   sn  stage        date        cohort           tag
    ...
    21     0.1211     0.1253  CRN   99.2%    1.60    1.16  0.392  fits     0  CONNECTIONS  2026-09-09  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_ls2
    22     0.1231     0.1742  CRN   99.6%    1.70    1.11  0.355  fits     0  NEURONS      2026-09-17  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337004_pipeN
    23     0.1232     0.1147  CRN   99.2%    1.63    1.15  0.309  fits     0  CONNECTIONS  2026-09-07  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337005
    24     0.1247     0.1110  CRN   98.2%    1.47    0.98  0.332  fits     0  CONNECTIONS  2026-09-19  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337005_hd29
    25     0.1252     0.1548  rot   98.6%    1.55    0.95  0.477  qspi?    0  CONNECTIONS  2026-09-04  sweepladder      SL_C_b32n256_cf21_brushless_L4C_g10_s31337003
```
...
```
  rank  same-rule  fit  stable     err  steady      alt  h743   gate-dist  Δrank  tag
     ...
     5     0.1002  CRN   98.6%    1.19    0.76  0.440  qspi      0.1870    +55  SL_C_b24n256_cf21_brushless_L4C_g10_s31337003_bd
    ...
    10     0.1047  CRN   99.4%    1.40    1.03  0.494  fits      0.1317    +22  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_l090_l
    ...
    15     0.1110  CRN   99.4%    1.49    0.98  0.435  fits      0.1247     +9  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005_hd29
    16     0.1122  CRN   99.8%    1.58    1.14  0.394  qspi      0.1442    +28  TAB_on_b32n256_cf21_brushless_L4C_s31337002
    ...
    19     0.1147  CRN   99.6%    1.58    1.11  0.349  fits      0.1232     +4  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005
    20     0.1149  CRN   99.2%    1.51    0.95  0.314  fits      0.1149     -3  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_mut1ta
    21     0.1163  CRN   99.2%    1.53    1.12  0.237  qspi      0.1472    +27  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005_ls4
    22     0.1181  CRN   99.0%    1.52    1.02  0.538  fits      0.1181     -2  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005_hd
    23     0.1204  CRN   99.2%    1.59    1.02  0.280  fits*     0.1352    +12  SL_C_b24n256_cf21_brushless_L4C_g10_s31337006_hd29
    24     0.1214  CRN   99.4%    1.64    1.07  0.294  fits      0.1950    +38  SL_C_b24n256_cf21_brushless_L4C_g10_s31337003_hd
    25     0.1221  CRN   99.4%    1.65    1.24  0.331  fits      0.1664    +30  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_hd
```
