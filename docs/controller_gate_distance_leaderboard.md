...
```
markers with a headline held-out : 246
  altitude regimen (alt= present) : 162
  attitude-only                   : 84
  state-neuron count unreadable   : 0  (no .out on disk)
  h743 keys counted exactly       : 52  (experiments/h743_keys.json)
...
```
  rank  same-rule  fit  stable     err  steady      alt  h743   gate-dist  Δrank  tag
     ...
     5     0.1002  CRN   98.6%    1.19    0.76  0.440  3.5x      0.1870    +48  SL_C_b24n256_cf21_brushless_L4C_g10_s31337003_bd
    ...
    21     0.1214  CRN   99.4%    1.64    1.07  0.294  fits      0.1950    +34  SL_C_b24n256_cf21_brushless_L4C_g10_s31337003_hd
    22     0.1221  CRN   99.4%    1.65    1.24  0.331  fits      0.1664    +26  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_hd
