...
```
markers with a headline held-out : 264
  altitude regimen (alt= present) : 180
  attitude-only                   : 84
  state-neuron count unreadable   : 0  (no .out on disk)
  h743 keys counted exactly       : 70  (experiments/h743_keys.json)
  h743 fits, exact / bound        : 35 / 50
  h743 off-chip (16 MB QSPI) tier : 35 / 17
...
```
  ...
  rank  gate-dist  same-rule  fit  stable     err  steady     alt  h743   sn  stage        date        cohort           tag
    ...
    24     0.1165     0.1389  CRN   99.4%    1.57    0.91  0.229  qspi     0  GRID         2026-09-21  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_pipeN3
    25     0.1167     0.1241  CRN   99.0%    1.50    0.80  0.595  qspi?    0  CONNECTIONS  2026-09-05  translationab    TAB_on_b32n256_cf21_brushless_L4C_s31337004
```
...
```
  rank  same-rule  fit  stable     err  steady      alt  h743   gate-dist  Δrank  tag
     ...
     9     0.1002  CRN   98.6%    1.19    0.76  0.440  qspi      0.1870    +60  SL_C_b24n256_cf21_brushless_L4C_g10_s31337003_bd
    ...
    15     0.1047  CRN   99.4%    1.40    1.03  0.494  fits      0.1317    +25  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_l090_l
    ...
    20     0.1110  CRN   99.4%    1.49    0.98  0.435  fits      0.1247    +12  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005_hd29
    21     0.1122  CRN   99.8%    1.58    1.14  0.394  qspi      0.1442    +32  TAB_on_b32n256_cf21_brushless_L4C_s31337002
    ...
    24     0.1147  CRN   99.6%    1.58    1.11  0.349  fits      0.1232     +7  SL_C_b24n256_cf21_brushless_L4C_g10_s31337005
