...
```
  ...
  rank  gate-dist  same-rule  fit  stable     err  steady     alt  h743   sn  stage        date        cohort           tag
    ...
    25     0.1271     0.1271  CRN   99.0%    1.65    1.35  0.351  fits     0  CONNECTIONS  2026-09-04  sweepladder      SL_C_b24n256_cf21_brushless_L4C_g10_s31337003
```
...
```
  rank  same-rule  fit  stable     err  steady      alt  h743   gate-dist  Δrank  tag
    ...
    10     0.1047  CRN   99.4%    1.40    1.03  0.494  fits      0.1317    +19  SL_C_b24n256_cf21_brushless_L4C_g10_s31337002_l090_l
    ...
    15     0.1122  CRN   99.8%    1.58    1.14  0.394  2.5x      0.1442    +24  TAB_on_b32n256_cf21_brushless_L4C_s31337002
