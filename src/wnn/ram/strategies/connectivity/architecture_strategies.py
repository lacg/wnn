...
def create_architecture_ga(
	...
	"""Create an ArchitectureGAStrategy with common configuration."""
	arch_config = ArchitectureConfig(
...
def create_architecture_ts(
	...
	"""Create an ArchitectureTSStrategy with common configuration."""
	arch_config = ArchitectureConfig(
		num_clusters=num_clusters,
		min_bits=min_bits,
		max_bits=max_bits,
