...
fn bucket_ordered(neurons: &[u32], keys: &[u64], values: &[u8]) -> (Vec<(u32, u64)>, Vec<Vec<u8>>)
{
...
pub fn drop_changed_neurons(neurons: &[u32], addrs: &[u64], values: &[u8], changed: &[u32])
	-> Cells
{
