...
DIR=logs/controller/W2_h3h4_20260621/seed0_base20260609
mkdir -p "$DIR"
echo "[w2-h3h4] $(date '+%Y-%m-%d %H:%M:%S') START — W2 weights + H3(decouple) + H4(axis-curriculum), delta"
$PY -u -m wnn.control.phased_ga \
  ...
  --decouple-outputs --axis-curriculum \
