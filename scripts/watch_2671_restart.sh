#!/bin/bash
# Watches flow 2671. When it reaches terminal status, restarts the worker
# (to pick up commit 0b7f084d — empirical_cumulative GA-fitness weights) and
# requeues any flow that was running at the moment of restart.
#
# Usage:
#   nohup bash scripts/watch_2671_restart.sh >> watcher.log 2>&1 &
