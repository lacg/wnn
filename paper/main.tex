...
discovers optimal neuron configurations---count, address width, and
connectivity---through genetic algorithm and tabu search, with connectivity
optimization effectively performing automated feature selection intrinsic
to the architecture. We evaluate on three standard IDS benchmarks (UNSW-NB15,
