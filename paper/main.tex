...
\usepackage{graphicx}
%\usepackage{booktabs}  % install: sudo tlmgr install booktabs
\usepackage{amsmath}
\usepackage{hyperref}
\usepackage{xcolor}
%\usepackage{multirow}  % install: sudo tlmgr install multirow
%\usepackage{algorithm}  % install: sudo tlmgr install algorithms
%\usepackage{algpseudocode}  % install: sudo tlmgr install algorithmicx
