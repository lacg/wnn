...
% Our contribution
We address both limitations. First, we introduce an optimization framework
...
automated feature selection intrinsic to the WNN architecture. Second, we evaluate rigorously on three datasets using
